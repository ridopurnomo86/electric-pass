...
const Confirmation = ({ amount, billingData, selectedPlans }: ConfirmationPropsType) => (
  <div className="size-full p-4 md:px-10">
    ...
    <CheckoutForm amount={amount} billingData={billingData} selectedPlans={selectedPlans} />
  </div>
);
