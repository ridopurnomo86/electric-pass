    ...
    <div className="flex h-full flex-col justify-between">
      <div>
        ...
        <nav className="space-y-2">
          ...
          >
            ...
            <p className="ml-3 mt-1 text-sm font-medium text-neutral-600 antialiased">Dashboard</p>
          </Link>
          <Link
            to="/reporting"
            className="flex cursor-pointer items-center rounded-md p-2 hover:bg-neutral-100"
          >
            ...
            <p className="ml-3 mt-1 text-sm font-medium text-neutral-600 antialiased">Reporting</p>
          </Link>
          {isAuthenticated && (
            <Link
              to="/settings"
              className="flex cursor-pointer items-center rounded-md p-2 hover:bg-neutral-100"
            >
              <Icon icon="ic:round-settings" className="text-2xl text-neutral-600" />
              <p className="ml-3 mt-1 text-sm font-medium text-neutral-600 antialiased">Settings</p>
            </Link>
          )}
        </nav>
      </div>
      <div className="mb-4">
        <Link
          ...
          className="flex cursor-pointer items-center rounded-md p-2 hover:bg-neutral-100"
        >
          <Icon icon="mdi:customer-service" className="text-2xl text-neutral-600" />
          <p className="ml-3 mt-1 text-sm font-medium text-neutral-600 antialiased">Support</p>
        </Link>
        {isAuthenticated && (
          <form method="POST" action="/logout" className="p-2">
            <button>
              <div className="flex items-center">
                <Icon icon="solar:logout-outline" className="text-2xl text-red-600" />
                <p className="ml-3 text-sm font-medium text-red-600 antialiased">Logout</p>
              </div>
            </button>
          </form>
        )}
